...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-substrate-talk-blog"),
	impl_name: create_runtime_str!("node-substrate-talk-blog"),
	authoring_version: 1,
...
/// Configure the pallet-blog in pallets/blog.
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		...
		fn dispatch_benchmark(
			...
			add_benchmark!(params, batches, pallet_blog, TemplateModule);
